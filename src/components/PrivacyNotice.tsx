    ...
    <div className="fixed top-4 right-4 z-50 max-w-sm animate-in">
      <div className="bg-blue-600/10 border border-blue-600/30 rounded-lg p-4 shadow-lg backdrop-blur-sm">
        ...
        <p className="text-xs text-gray-300 leading-relaxed">
          Your calculations are processed locally in your browser. We use cookies to remember your preferences and optional Google Analytics to improve our service after you consent.
        </p>
